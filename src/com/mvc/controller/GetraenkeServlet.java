...
public class GetraenkeServlet extends HttpServlet
{
	...
	{
		RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/apps/dynamische/viewGetraenke.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		request.getRequestDispatcher("/apps/dynamische/viewGetraenke.jsp").forward(request, response);
	} 
}