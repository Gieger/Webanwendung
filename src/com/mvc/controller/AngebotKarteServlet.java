...
//URl-Mapping
@WebServlet("/Menue") 
public class AngebotKarteServlet extends HttpServlet
{
	private static final long serialVersionUID = 1L;
	public AngebotKarteServlet()
	{
	}
	...
	{
		RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/apps/dynamische/viewMenue.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		request.getRequestDispatcher("/apps/dynamische/viewMenue.jsp").forward(request, response);
	} 
}