...
//URl-Mapping
@WebServlet("/Hauptspeisen") 
public class HauptspeisenServlet extends HttpServlet
{
	private static final long serialVersionUID = 1L;
	public HauptspeisenServlet()
	{
	}
	...
	{
		RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/apps/dynamische/viewHauptspeisen.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		request.getRequestDispatcher("/apps/dynamische/viewHauptspeisen.jsp").forward(request, response);
	} 
}