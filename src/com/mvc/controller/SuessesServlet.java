...
//URl-Mapping
@WebServlet("/Suesses") 
public class SuessesServlet extends HttpServlet
{
	private static final long serialVersionUID = 1L;
	public SuessesServlet()
	{
	}
	...
	{
		RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/apps/dynamische/viewSuesses.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		request.getRequestDispatcher("/apps/dynamische/viewSuesses.jsp").forward(request, response);
	} 
}