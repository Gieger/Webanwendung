...
<html lang="de">
	...
	<body class="vbox viewport">
		...
		<section class="main hbox space-between">
			<aside class="side">
				<ul>
		            <li><a class="asidelink choose" href="${pageContext.request.contextPath}/Menue"><i class="far fa-caret-square-right"></i> Angebote</a></li>
		            <li><a class="asidelink" href="${pageContext.request.contextPath}/Vorspeisen"><i class="far fa-caret-square-right"></i> Vorspeisen</a></li>
			...
			<article class="text">
				...
				<form method="post" action="${pageContext.request.contextPath}/Menue">
				    <p>Welche Angebote möchten Sie angezeigt bekommen?</p>
				    <input type="checkbox" name="met" value="mittag" />Mittagstisch
				    <input type="checkbox" name="met" value="saison" />Saison
				    <input type="checkbox" name="met" value="spezial" />Spezial
				    <input type="hidden" name="selectedMenueTagg" id="selectedMenueTagg"/>
				    <%--Übergibt die Daten an das Javascript menueKarte.js beim ankllicken--%>
