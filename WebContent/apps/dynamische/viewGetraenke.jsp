		...
		<section class="main hbox space-between">
			<aside class="side">
				<ul>
		            ...
		            <li><a class="asidelink choose" href="${pageContext.request.contextPath}/Getraenke"><i class="far fa-caret-square-right"></i> Getränke</a></li>
		       </ul>
			</aside>
			<article class="text">
				<h2>Getränkekarte</h2>
				<%--Form mit checkboxen, damit der User die Speisekarte die er sehen will auswählen kann.--%>
				<form method="post" action="${pageContext.request.contextPath}/Getraenke">
				    <p>Welche Getränke möchten Sie angezeigt bekommen?</p>
				    <input type="checkbox" name="met" value="alcfrei" />Alkoholfrei
				    <input type="checkbox" name="met" value="bier" />Bier
				    <input type="checkbox" name="met" value="schnaps" />Schnaps
