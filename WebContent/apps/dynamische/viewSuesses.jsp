		...
		<section class="main hbox space-between">
			<aside class="side">
				<ul>
		            ...
		            <li><a class="asidelink choose" href="${pageContext.request.contextPath}/Suesses"><i class="far fa-caret-square-right"></i> Süßes</a></li>
			...
			<article class="text">
				...
				<form method="post" action="${pageContext.request.contextPath}/Suesses">
				    <p>Welche Gerichte möchten Sie angezeigt bekommen?</p>
				    <input type="checkbox" name="met" value="gebackenes" />Gebackenes
				    <input type="checkbox" name="met" value="obst" />Obst
				    <input type="checkbox" name="met" value="eis" />Eis
