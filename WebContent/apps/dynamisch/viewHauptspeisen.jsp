		...
		<section class="main hbox space-between">
			<aside class="side">
				<ul>
		            ...
		            <li><a class="asidelink choose" href="${pageContext.request.contextPath}/Hauptspeisen"><i class="far fa-caret-square-right"></i> Hauptspeisen</a></li>
			...
			<article class="text">
				...
				<form method="post" action="${pageContext.request.contextPath}/Hauptspeisen">
				    <p>Welche Gerichte möchten Sie angezeigt bekommen?</p>
				    <input type="checkbox" name="met" value="burger" />Burger
				    <input type="checkbox" name="met" value="steak" />Steak
				    <input type="checkbox" name="met" value="vegie" />Vegie
